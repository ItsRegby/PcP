...
package body ada_main is
   ...
   E167 : Short_Integer; pragma Import (Ada, E167, "queuepackage_E");
   E195 : Short_Integer; pragma Import (Ada, E195, "stackpackage_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "stackpackage__finalize_spec");
      begin
         F1;
      end;
      E167 := E167 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "queuepackage__finalize_spec");
      begin
         F2;
      end;
      E177 := E177 - 1;
   ...
   begin
      ...
      E197 := E197 + 1;
      queuepackage'elab_spec;
      E167 := E167 + 1;
      stackpackage'elab_spec;
      E195 := E195 + 1;
   end adainit;
...
--  BEGIN Object file/option list
   --   D:\PRODUCER_CONSUMER-master\obj\queuePackage.o
   --   D:\PRODUCER_CONSUMER-master\obj\stackPackage.o
   --   D:\PRODUCER_CONSUMER-master\obj\main.o
   --   -LD:\PRODUCER_CONSUMER-master\obj\
   --   -LD:\PRODUCER_CONSUMER-master\obj\
